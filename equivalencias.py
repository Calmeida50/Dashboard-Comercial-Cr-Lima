...
VENDEDOR = {
    ...
    # KUCHAK: era HEIDI por engano; e da SILVIA. Corrigido em 14/08/2026.
    # Vale para TODAS as empresas, mesmo as que hoje nao tem venda dele — se
    # aparecer venda nova em outra marca, ja cai na vendedora certa.
    ("GRANADO",    "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("BELLIZ",     "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("CLESS",      "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("PAYOT",      "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("PRUDENCE",   "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("EVER GREEN", "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("FIAT LUX",   "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("KISABOR",    "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("AQUAFAST",   "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("BOTÂNICA",   "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",
    ("DEPIMIEL",   "KUCHAK COMERCIAL DE ALIMENTOS LTDA"): "SILVIA",

    # TAVARES: era AHMANDA (via cadastro, nao havia regra aqui); e da GRAZI.
    # Corrigido em 14/08/2026, para TODAS as empresas.
    ("GRANADO",    "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("BELLIZ",     "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("CLESS",      "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("PAYOT",      "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("PRUDENCE",   "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("EVER GREEN", "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("FIAT LUX",   "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("KISABOR",    "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("AQUAFAST",   "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("BOTÂNICA",   "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",
    ("DEPIMIEL",   "TAVARES COMERCIO DE ALIMENTOS LTDA"): "GRAZI",

    # LUMIER: ja estava com a SUELI em BELLIZ, CLESS e GRANADO; so a PAYOT
    # apontava para AHMANDA. Uniformizado para SUELI em 14/08/2026.
    ("GRANADO",    "LUMIER COSMETICOS LTDA"): "SUELI",
    ("BELLIZ",     "LUMIER COSMETICOS LTDA"): "SUELI",
    ("CLESS",      "LUMIER COSMETICOS LTDA"): "SUELI",
    ("PAYOT",      "LUMIER COSMETICOS LTDA"): "SUELI",
    ("PRUDENCE",   "LUMIER COSMETICOS LTDA"): "SUELI",
    ("EVER GREEN", "LUMIER COSMETICOS LTDA"): "SUELI",
    ("FIAT LUX",   "LUMIER COSMETICOS LTDA"): "SUELI",
    ("KISABOR",    "LUMIER COSMETICOS LTDA"): "SUELI",
    ("AQUAFAST",   "LUMIER COSMETICOS LTDA"): "SUELI",
    ("BOTÂNICA",   "LUMIER COSMETICOS LTDA"): "SUELI",
    ("DEPIMIEL",   "LUMIER COSMETICOS LTDA"): "SUELI",
    ...
    # (a regra PAYOT/LUMIER -> AHMANDA foi removida em 14/08/2026; ela vinha
    #  DEPOIS do bloco novo e, num dicionario, a ultima vence — anularia a
    #  correcao silenciosamente)
